...
//        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(net.minecraft.tileentity.TileEntityHopper.class, new String[]{"Items"}));
//    }
    ...
    protected boolean updateHopper() {
        if (this.world != null && !this.world.isRemote) {
            if (!this.isOnTransferCooldown() && BlockUpSideDownHopper.isEnabled(this.getBlockMetadata())) {
                boolean flag = false;
...
//        }
        ...
        if (iinventory == null) {
            ...
            EnumFacing enumfacing = BlockUpSideDownHopper.getFacing(this.getBlockMetadata()).getOpposite();
...
//    }
    ...
    private IInventory getInventoryForHopperTransfer() {
        EnumFacing enumfacing = BlockUpSideDownHopper.getFacing(this.getBlockMetadata());
