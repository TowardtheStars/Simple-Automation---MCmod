...
import fvortex.simpauto.tileentity.TileEntityUpSideDownHopper;
...
public class BlockUpSideDownHopper extends BlockContainer
{
    ...
    protected static final AxisAlignedBB BASE_AABB = new AxisAlignedBB(0.0D, 0.375D, 0.0D, 1.0D, 1.0D, 1.0D);
    ...
    public BlockUpSideDownHopper()
    {
        ...
        this.setUnlocalizedName("upsideDownHopper");
    }
    ...
    {
        return new TileEntityUpSideDownHopper();
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityUpSideDownHopper)
            {
                ((TileEntityUpSideDownHopper)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (tileentity instanceof TileEntityUpSideDownHopper)
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityUpSideDownHopper)tileentity);
